...
def set_incremental_priors(K,D,prior_std, param_history = None):
...
def get_h_and_v_params(K,D,experimental_condition = 0, prior_std = 1, data = None, param_history = None):
    assert D > 0
    assert K > 0
